declare namespace MathQuill {
	...
	namespace v3 {
		...
		interface API {
			...
			R: 1;
			config(options: Config): void;
			registerEmbed(name: string, options: (data: v1.EmbedOptionsData) => v1.EmbedOptions): void;
		}
	}
	...
	namespace v1 {
		...
		interface API {
			...
			R: 1;
			config(options: Config): void;
			registerEmbed(name: string, options: (data: EmbedOptionsData) => EmbedOptions): void;
		}
	}
